...
import { ArrowUp, Github, Linkedin, Mail, Heart, Twitter, Rss } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="py-16 border-t border-border/40 bg-secondary/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div className="lg:col-span-2">
              <h3 className="text-2xl font-bold mb-4 gradient-text">Amir Siddiqui</h3>
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="p-3 rounded-xl bg-card/50 border border-border/60 hover:border-primary/40 hover:bg-primary/10 transition-all duration-300 hover:scale-110"
                  aria-label="GitHub"
                >
